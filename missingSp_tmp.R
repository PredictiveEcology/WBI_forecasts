  ...
  for (CS in c("CanESM5", "CNRM-ESM2-1")) {
    for (SS in c("SSP370", "SSP585")) {
      for (P in c("AB", "BC", "SK", "MB", "YT", "NT")) {
        ...
        missingSp <- c("LALO", "LCSP", "LEFL", "LEYE", "LISP", "MAWA", "MODO", "MOWA",
                       "NAWA", "NOFL", "NOWA", "OCWA", "OSFL", "OVEN", "PAWA", "PHVI",
                       "PIGR", "PISI", "PIWO", "PUFI", "RBGR", "RBNU", "RCKI", "RECR",
                       "REVI", "RUBL", "RUGR", "RWBL", "SAVS", "SEWR", "SOSA", "SOSP",
                       "SPSA", "SWSP", "SWTH", "TEWA", "TOSO", "TOWA", "TRES", "VATH",
                       "VEER", "VESP", "WAVI", "WBNU", "WCSP", "WETA", "WEWP", "WIPT",
                       "WISN", "WIWA", "WIWR", "WTSP", "WWCR", "YBFL", "YBSA", "YEWA",
                       "YHBL", "YRWA")
        birdSpecies <- birdSpecies[Species %in% missingSp, ]
