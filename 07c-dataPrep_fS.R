...
if (isTRUE(usePrerun)) {
  ...
  fSsimDataPrep$fireSense_nonAnnualSpreadFitCovariates$year2001_year2002_year2003_year2004_year2005_year2006_year2007_year2008_year2009_year2010 <- as.data.table(fSsimDataPrep$fireSense_nonAnnualSpreadFitCovariates$year2001_year2002_year2003_year2004_year2005_year2006_year2007_year2008_year2009_year2010)
